data = {
  ...
  'DZA': {'COUNTRY': 'Algeria', 'POP': 43.38, 'AREA': 2_381.74,'GDP': 167.56, 'CONT': 'Africa', 'IND_DAY': '1962-07-05'},'CAN': {'COUNTRY': 'Canada', 'POP': 37.59, 'AREA': 9_984.67,'GDP': 1_647.12, 'CONT': 'N.America', 'IND_DAY': '1867-07-01'},
...
import pandas as pd
df = pd.DataFrame(data=data).T # reverse rows/columns
#print(df)
#df.to_csv('files/countries.csv')
#df.to_excel('files/countries.xlsx', sheet_name='COUNTRIES')
#df = pd.read_excel('files/countries.xlsx', index_col=0)
#print(df)
#df.to_json('files/countries.json')
#df.to_html('files/countries.html')
